import { FaTimes, FaMapMarkerAlt, FaStar, FaCar } from 'react-icons/fa';
      ...
      <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto animate-slideIn">
        <div className="p-6">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="text-xl font-bold text-red-700">{shop.name}</h3>
          ...
          <div className="mt-4">
            <h4 className="font-bold text-gray-800 mb-2">Популярные товары:</h4>
          ...
          <button className="w-full mt-6 bg-red-700 text-white py-3 rounded-lg hover:bg-red-800 transition">
            Перейти к магазину
          </button>
        </div>
      </div>
